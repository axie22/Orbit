                    ...
                    <section className="flex flex-col gap-6">
                        ...
                        <div className="grid gap-6 md:grid-cols-3">
                            ...
                            <div className="bg-white rounded-lg border border-slate-200 p-5 shadow-sm">
                                ...
                                <p className="mt-2 text-sm text-slate-600 leading-relaxed">
                                    Matthew is a is a frontend-leaning full-stack engineer with a passion for building intuitive and engaging user experiences.
                                    He also has experience building scalable backend systems and integrating AI technologies into web applications.
                                    His work focuses on creating seamless interfaces, optimizing performance, and using AI to enhance user interactions.
